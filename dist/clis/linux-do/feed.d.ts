import { type Arg, type CommandArgs } from '@jackwener/opencli/registry';
...
export declare function fetchLinuxDoJson(page: IPage | null, apiPath: string, options?: FetchJsonOptions): Promise<any>;
/**
 * 将命令参数转换为最终请求地址
 */
